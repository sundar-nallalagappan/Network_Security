...
class TrainingPipeline:
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact) -> ModelTrainerArtifact:
        try:
            self.model_trainer_config:ModelTrainerArtifact = ModelTrainerConfig(training_pipeline_config=self.training_pipeline_config)    
    ...
    def run_pipeline(self):
        try:
            ...
            print('data_ingestion:', data_ingestion_artifact)
            ...
            print('model_evaluation_artifact:', model_evaluation_artifact)
            
            if not model_evaluation_artifact.is_model_accepted:
                raise Exception("Trained model is not better than bst model")
            
            model_pusher_artifact = self.start_model_pusher(model_evaluation_artifact=model_evaluation_artifact)
            print('model_pusher_artifact', model_pusher_artifact)
